...
import 'file:///D:/LEWY/Dev/Projects/ROUGH/Flutter/rento_main/lib/screens/home-details/perfect-home-details-screen.dart';

class PerfectSectionColumns extends StatefulWidget {
  final Function toggleViewStyle;
  PerfectSectionColumns({this.toggleViewStyle});

  @override
  _PerfectSectionColumnsState createState() => _PerfectSectionColumnsState();
}

class _PerfectSectionColumnsState extends State<PerfectSectionColumns> {
  //toggleViewStyle
                  ...
                  onPressed: () {
                    setState(() {
                      perfectHomes[index].isLiked
                          ? perfectHomes[index].isLiked = false //true
                          : perfectHomes[index].isLiked = true; //false
                    });
                  },
                  child: Container(
                    alignment: Alignment.topRight,
                    child: perfectHomes[index].isLiked == true //true
                        ? Icon(
                            Icons.favorite,
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        ...
                                        Container(
                                          ...
                                          child: FittedBox(
                                            child: Text(
                                              '${perfectHomes[index].reviews.toString()}k Reviews',
                                              style: TextStyle(
